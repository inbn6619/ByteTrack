...
def Tracker():
    ...
    # with open('/home/ubuntu/Track_sample/ch1-1_tiny.txt', 'r') as f:
        while True:
            ...
            if len(data) > 1:
                if past_channel_name != channel_name:
                    ...
                    if len(coordinate) != 0 and len(cams) == 3:
                        ...
                        if channel_name == 'ch2':
                            ...
                            for num in range(len(tracked_targets)):
                                ...
                                dict_minimap[tracked_targets[num].track_id] = pm_1.pixel_to_lonlat([center[0], center[1]])
                            ...
                            for num in range(len(tracked_targets)):
                                ...
                                # distance 사용하여 중복 Track 객체 삭제 알고리즘 사용하기 위한 변수 value 저장
                                dict_minimap[tracked_targets[num].track_id] = pm_2.pixel_to_lonlat([center[0], center[1]])
                                dict_img[tracked_targets[num].track_id] = center
                            ...
                            for num in range(len(tracked_targets)):
                                ...
                                # distance 사용하여 중복 Track 객체 삭제 알고리즘 사용하기 위한 변수 value 저장
                                dict_minimap[tracked_targets[num].track_id] = pm_3.pixel_to_lonlat([center[0], center[1]])
                                dict_img[tracked_targets[num].track_id] = center
                ...
                print("<<<<<<<<<<Finish>>>>>>>>>>")
                break
            past_channel_name = channel_name
